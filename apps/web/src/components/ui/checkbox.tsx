  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "flex h-4 w-4 shrink-0 items-center justify-center rounded-[4px] border border-border-strong bg-surface text-primary-foreground transition-colors duration-fast ease-out disabled:cursor-not-allowed disabled:opacity-50",
